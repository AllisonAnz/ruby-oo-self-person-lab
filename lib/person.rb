...
class Person
    ...
    attr_accessor :bank_account #a new person can change their bank account
    attr_reader :name, :happiness, :hygiene
    
    def initialize(name) #a new person is initialize with a name
        @name = name #name cannot be changed
        @bank_account = 25.0 #bank account balance of $25
        @happiness = 8 
        @hygiene = 8 
    end
